...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        """Adds the core transformation for this model of input
        data into a batch of predictions. In this case, the t which transforms a batch transformation is a linear layer plus a
        ...
        with tf.variable_scope('softmax-classifier'):
            W = tf.Variable(tf.fill((self.config.n_features, self.config.n_classes),0.0))
