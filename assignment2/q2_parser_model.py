...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.nn.embedding_lookup(params = embed, ids = self.input_placeholder)
    ...
    def add_prediction_op(self):
        ...
        self.W =W= init([self.config.n_features * self.config.embed_size,self.config.hidden_size])
